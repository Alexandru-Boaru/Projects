 ...
 *
 * @author alex
 * clasa care se ocupa cu executia comenzii Touch
 */
public class TouchCommand implements Command{
     ...
     */
    public TouchCommand(Tree root, String[] parts){
        if(parts[1].charAt(0)=='/'){
            virtual=root;
        }
        else{
        ...
        if(parts[1].lastIndexOf('/')>=0){
            errmes1="touch: "+parts[1].substring(0,parts[1].lastIndexOf('/')) +": No such directory";
        }
        errmes2_1="touch: cannot create file ";
        errmes2_2=": Node exists";
    }
    
    /**
     * Functia cauta path-ul pana la directorul dat ca argument si creeaza in acesta un nou TextFile
     */
    public void execute(){
        int check=0;
        ...
        if(check==1){
            ...
            Tree t= new Tree(virtual,name,1);
            virtual.add(t);
        }
    }
}
