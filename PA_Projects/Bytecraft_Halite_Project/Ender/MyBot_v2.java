    ...
    public static void main(final String[] args) {
        ...
        for (;;) {
            ...
            for(final Ship ship : me.ships.values()){
                ...
                if(game.turnNumber >= Constants.MAX_TURNS*0.90){    //in ultimele 10% din ture toate navele
                ...
                if(ship.isFull() || fullShips.contains(ship.id.id)){    //daca o nava se umple, atunci ea se
                    ...
                    if(dist>10 && me.halite>8000 && built){             //daca nu exista un dropoff in vecinatate
                ...
                for(Position i:p){                                      //se cauta in care din cele 4 directii
                    ...
                    if(gameMap.at(i).halite>max.halite &&
                        ...
                        game.turnNumber < Constants.MAX_TURNS*0.90){
